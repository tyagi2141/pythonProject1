...
class ExperimentGenerator:
    ...
    def getWinner(self, board=0):
        ...
        if self.isDone(board):
            ...
            print
            "Game not done, cannot determine winner"
    ...
    def printBoard(self, board=0):
        ...
        ""
        print
        sboard[0][0] + '|' + sboard[0][1] + '|' + sboard[0][2]
        print
        "-----"
        print
        sboard[1][0] + '|' + sboard[1][1] + '|' + sboard[1][2]
        print
        "-----"
        print
        sboard[2][0] + '|' + sboard[2][1] + '|' + sboard[2][2]
        print
        ""
...
print
"X won " + str(xwins) + " games."
print
"O won " + str(owins) + " games."
print
"There were " + str(draws) + " draws."
